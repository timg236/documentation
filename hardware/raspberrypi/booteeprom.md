...
The [release notes](https://github.com/raspberrypi/rpi-eeprom/blob/master/firmware/release-notes.md) for the Raspberry Pi4 bootloader EEPROMs are stored in the [rpi-eeprom Github repo](https://github.com/raspberrypi/rpi-eeprom/).
